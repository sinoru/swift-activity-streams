...
>: ActivityProtocol {
    public static var type: String {
        Read<ActivityTypes.Object, ActivityTypes.Object>.type
    }
...
extension Read<Object, Object> {
    static let type: String = "Read"
}

extension Read: Equatable where Actor: Equatable, Object: Equatable { }

extension Read: Hashable where Actor: Hashable, Object: Hashable { }

extension Read: Codable where Actor: Codable, Object: Codable {
